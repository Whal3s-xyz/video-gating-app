...
export default function Hero({className, onStart}: { className?: string, onStart?: any}) {

    // @ts-ignore
    return (

        <div className={`relative isolate transition-opacity ease-in duration-700 ${className}`}>
            <svg
                    ...
                    <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                        <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                            ...
                            <h1 className="mt-6 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                                Token gate your videos with Livepeer and Whal3s.
                            </h1>
